...
public readonly record struct PathMapping
{
	...
	public string LocalFullPath  => GamePath + LocalRelativePath;
	public string RemoteFullPath => RootPath + RemoteRelativePath;
	public string LocalFullPathLower => (GamePath + LocalRelativePath).ToLower();
	public string RemoteFullPathLower => (RootPath + RemoteRelativePath).ToLower();
